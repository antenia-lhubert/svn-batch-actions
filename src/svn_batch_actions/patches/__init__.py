...
def patch(working_dir: Path, enabled_patches: List[str] = None, verbose: bool = False) -> None:
    """
    ...
    """
    # Default to all patches if none specified
    if enabled_patches is None:
        enabled_patches = list(AVAILABLE_PATCHES.keys())
