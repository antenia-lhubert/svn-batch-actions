...
- Encoding detection: overrides misidentified encodings to cp1252 (Windows-1252) when detecting other Windows code pages (cp1250, cp1251, etc.) or Mac encodings (mac_latin2, mac_roman, etc.), since cp1252 is the most common in Windows-based Western projects
